...
namespace Scommerce\CatalogUrl\Model\Entity\Attribute\Source;

/**
 * Class Categories
 * @package Scommerce\CatalogUrl\Model\Entity\Attribute\Source
 */
class Categories extends \Magento\Eav\Model\Entity\Attribute\Source\Table
{
    ...
    public function __construct(
     ...
     public function getCategories()
     {
         ...
         if (!$this->helper->isCatalogUrlActive()) return $categoryOption;
