...
namespace MageWorx\SearchSuiteSphinx\Controller\Adminhtml\Check;
...
/**
 * SearchSuiteSphinx check Sphinx availabilty action
 */
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        return $result->setData($this->helperSphinx->checkSphinxStatus());
    }
