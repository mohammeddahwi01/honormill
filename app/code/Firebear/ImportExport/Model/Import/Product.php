    ...
    protected function saveProducts()
    {
        ...
        while ($nextBunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            foreach ($nextBunch as $rowNum => $rowData) {
                ...
                $this->skuProcessor->setNewSkuData($rowData[self::COL_SKU], 'attr_set_code', $rowData['_attribute_set'] );
                if (isset($this->_attrSetNameToId[$rowData['_attribute_set']])) {
